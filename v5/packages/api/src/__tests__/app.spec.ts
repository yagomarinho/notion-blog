...
import { extractPropertiesFromRecordMap } from '../shared/utils/extract.properties.from.record.map'
...
jest.mock('../shared/utils/extract.properties.from.record.map', () => ({
...
describe('application tests', () => {
  ...
  const app = Application({ routes }).exposeApp()
