...
import { createDeployOnVercel } from '../../modules/blog.post/services/create.deploy.on.vercel'
...
export interface DeployTimer {
  deploy: () => void
  clear: () => void
}

export function DeployTimer(time = DEFAULT_TIME): DeployTimer {
